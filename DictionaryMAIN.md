...
Este dicionário foi ajustado para refletir o modelo implementado em [main.py](main.py) e o caso de entrada em [dados_exemplo.dat](dados_exemplo.dat).

## Escopo de Referência

- Modelo: [main.py](main.py)
- Entrada-base: [dados_exemplo.dat](dados_exemplo.dat)
- Horizonte: 24 horas com discretização de 1 hora
- Cenario de exportacao: bloqueada no arquivo de dados atual (`allow_grid_export = 0`)
- Objetivo ativo no caso-base: anualizado (`use_article_like_objective = 1`)
...
**Valores do caso-base em [dados_exemplo.dat](dados_exemplo.dat):**
- `capex_pv_kw = 1200`
- `capex_bess_kwh = 700`
- `capex_trafo_kw = 1000`
...
|-----------|---------|-----------|-----------------|
| `crf_pv` | adimensional | Capital Recovery Factor anualizado para PV | 0.10–0.20 |
| `crf_bess` | adimensional | Capital Recovery Factor anualizado para BESS | 0.12–0.25 |
| `crf_trafo` | adimensional | Capital Recovery Factor anualizado para transformador | 0.08–0.15 |
...
- `export_price_factor = 0.70`
- `allow_grid_export = 0`
- `use_article_like_objective = 1`
...
**Sequências do caso-base em [dados_exemplo.dat](dados_exemplo.dat):**
- `irradiance_cf[t]` varia de 0.00 a 1.00
- `grid_price[t]` varia de 0.25 a 1.10 BRL/kWh
- `P_ev_load_kw[t]` varia de 20 a 135 kW
...
**Conjunto usado em [dados_exemplo.dat](dados_exemplo.dat):**
